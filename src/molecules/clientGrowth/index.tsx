import { ClientGrowthStyles } from "./styled-components";
import { dataClientGrowthProps } from "./type";
...
export function ClientGrowth({ dataClientGrowth }: dataClientGrowthProps) {
  return (
    <ClientGrowthStyles>
      <div className="container-statistic">
        <div className="title">Client Growth</div>
        {dataClientGrowth.map((growth, index) => {
          var bgColor2021 =
